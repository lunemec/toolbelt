...
require_line "phase: plan" "task phase default"
...
require_line "benchmark_workdir: ." "benchmark_workdir default"
require_line "gate_targets: []" "gate_targets default list"
require_line "scorecard_artifact: none" "scorecard_artifact default"
require_line "benchmark_opt_out_reason: none" "benchmark_opt_out_reason default"
...
assert_yaml_expr "$template_frontmatter" '.phase == "plan"' "phase defaults to plan"
...
assert_yaml_expr "$template_frontmatter" '.benchmark_workdir == "."' "benchmark_workdir defaults to ."
...
assert_yaml_expr "$template_frontmatter" '.benchmark_opt_out_reason == "none"' "benchmark_opt_out_reason defaults to none"
...
assert_yaml_expr "$created_frontmatter" '.phase == "plan"' "created task persists phase"
...
assert_yaml_expr "$created_frontmatter" '.benchmark_workdir == "."' "created task persists benchmark_workdir"
...
assert_yaml_expr "$created_frontmatter" '.benchmark_opt_out_reason == "none"' "created task persists benchmark_opt_out_reason"
